...
" Color of line numbers (only default color scheme)
highlight LineNr term=bold cterm=NONE ctermfg=Green ctermbg=Black gui=NONE guifg=Green guibg=Black
...
set cmdheight=2                 "Set the height of the cmd line on the bottom to 2 lines
...
set hidden                      "Allow buffers in the background without being in a window
...
set foldcolumn=0                "Do not display foldlevel in n wide gutter
