...
packages=(kitty zsh vim nvim exa wofi eww dunst fontconfig lxpolkit blueman git git-delta npm node python pip)
...
curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs --output "${rust_installer}"
